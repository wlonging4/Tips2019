var ComponentsDropdowns = function () {
    ...
    return {
        ...
        init: function () {            
            ...
            $(".js-chooseNothing").click(function(){
                $("#my_multi_select1").find("option").prop("selected",false);
                $(".ms-selection").find("li").hide();
                $(".ms-selectable").find("li").show();
            })
            $(".js-chooseAll").click(function(){
                $("#my_multi_select1").find("option").prop("selected",true);
                $(".ms-selection").find("li").show();
                $(".ms-selectable").find("li").hide();
            })
        }
    };
