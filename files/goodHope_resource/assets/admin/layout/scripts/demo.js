...
$.fn.multiSel = function (options){
    ...
    return this.each(function (){
        ...
        // 保存value;
        var $ipth = $('<input type="hidden" value="" name="'+defaults.name+'" />');
        ...
        for(var i = 0; i < count; i++){
            var divstr = '<div class="checkbox"><label style="width:100%;padding: 0 7px;">'+
...
$("body").append($("<div>",{
    ...
    "class": "modal fade",
    "tabindex": "1",
    "style": "z-index:10051;padding-top:15%"
