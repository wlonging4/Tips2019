'use strict';
function qicheDirectorController($scope,getProListFactory,getSelectListFactory,tools,DTOptionsBuilder, DTColumnBuilder) {
    $scope.form = {
    ...
    vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn('yixinstatusstr').withTitle('宜信员工').withOption('sWidth','70px').renderWith(function(data,type,full){
        ...
        DTColumnBuilder.newColumn('yixinusertypestr').withTitle('类型').withOption('sWidth','40px').notSortable(),
