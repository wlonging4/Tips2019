'use strict';
function caiyidealPaymentController($scope, getSelectListFactory, tools, DTOptionsBuilder, DTColumnBuilder) {
    ...
    /*
     获取枚举类型
     */
    var selectList = getSelectListFactory.getSelectList(['paystatus','terminalrom','payagentenum']);
