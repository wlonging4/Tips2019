'use strict';
function settled($scope, $stateParams, getSelectListFactory, tools, DTOptionsBuilder, DTColumnBuilder) {
    ...
    getSelectListFactory.getSelectList(['yixinusertype', 'biz_sys_route', 'month_settle_status']).then(function(data){
        ...
        $scope.select.status = data.appResData.retList[2].month_settle_status;
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions().withOption('ajax',{
            url: siteVar.serverUrl + '/xinghuosettle/tableSettle.shtml',
            type: 'POST',
            data: function(d){
    ...
    //    vm.dtColumns.splice(9, 0, DTColumnBuilder.newColumn('itmUser.yixinno').withTitle('员工编号').withOption('sWidth','90px'));
    //};
    ...
    function fnDrawCallback(data){
        $scope.$apply(function(){
            ...
            $scope.sumamount = tools.formatNumber((data.json.info && data.json.info.sumamount) || 0);
        });
        tools.createModal();
