...
Modal.prototype._createMask = function(){
    ...
    if(!mask){
        ...
        mask.style.cssText = "width:100%;height:" + h + "px;background:rgba(0, 0, 0, 0.3);position:fixed;top:0;left:0;display:none;";
...
Modal.prototype._createPopup = function(){
    ...
    if(!popup){
        ...
        popup.style.cssText = "position:fixed;z-index:11;top:10%;width:100%;left:50%;transform:translateX(-50%);-webkit-transform:translateX(-50%);display:none;";
        ...
        if(this.isPromptbtn){
            html += '<div class="bottomBtn topBorder"><a href="javascript:void(0);" class="twoBtn dialogCloseBtn">'+this.conisPromptText[1]+'</a><a href="javascript:void(0);" class="twoBtn">'+this.conisPromptText[0]+'</a></div>'
        }
        html +=    '</div>';
...
/**
 * Created by yugu10 on 2017/7/4.保密协议
 */
;(function(){
    var submitFlag = true,
...
window.onload=function(){
	[].slice.call(document.querySelectorAll(".twoBtn")).forEach(function(thisObj,index){
		thisObj.addEventListener("touchstart",function(){thisObj.classList.add("touchbtn")},false);
		thisObj.addEventListener("touchend",function(){thisObj.classList.remove("touchbtn")},false);
	});
